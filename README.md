...
[`go-bridget/mig`](https://github.com/go-bridget/mig) from `schema/`. It
exposes typed structs plus `Insert()/Select()/Update()/Delete()` query
builders. Both packages are used for testing.
